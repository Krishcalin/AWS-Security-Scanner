...
def build_fixture() -> dict:
    ...
    return {
        "_comment": "GENERATED by scripts/gen_wql_parity.py — do not edit by hand. "
                    "The Python engine (aws_wql.evaluate + aws_controls.control_finding) is the "
                    "oracle; wql.ts + controls.ts must match.",
        "graph": g.to_dict(),
        "cases": cases,
        "controls": controls,
    }
