...
from engine import aws_forensics
from engine import aws_malware
from engine import aws_policy
from hub import aws_registry_connectors
...
class PlatformService:
    ...
    def scorecards(self, *, workspace_id: Optional[str] = None,
        ...
        """
        from engine import aws_factors
        from engine import aws_ownership
        from engine import aws_scorecard
    ...
    def _finding_in_project(entry: dict, proj: dict) -> bool:
        ...
        if accts and entry.get("account") not in accts:
            return False
        if globs:
            from store.aws_state import _glob
    ...
    def build_evidence_bundle(self, account_id: str, *, generated_at: str,
        ...
        """
        from engine import aws_evidence
        from engine import aws_evidence_bundle
