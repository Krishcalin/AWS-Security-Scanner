...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/checks-563%20severity--mapped-red?style=flat-square" alt="563 severity-mapped checks"/>
...
- [Live Audit Scanner (`aws_live_scanner.py`)](#live-audit-scanner-aws_live_scannerpy)
  ...
  - [Security Checks Coverage (563 severity-mapped checks across 98 sections)](#security-checks-coverage-563-severity-mapped-checks-across-98-sections)
...
|---------|------|------|-------|--------|
| **OverWatch** (Live CNAPP) | `aws_live_scanner.py` | Live AWS API audit + security graph + attack-path CNAPP | Running AWS account (multi-account via AssumeRole) | 563 severity-mapped across 98 sections |
...
- **563 severity-mapped checks** across 98 audit sections (all 563 actionable, each with a detailed remediation write-up)
...
```bash
# Run full audit (all 98 sections, 563 severity-mapped checks)
...
### Security Checks Coverage (563 severity-mapped checks across 98 sections)
