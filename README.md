...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-180%20passing-brightgreen?style=flat-square" alt="180 Tests"/>
</p>
...
| **Live Audit Scanner** | `aws_live_scanner.py` | Live AWS API audit + security graph + CNAPP | Running AWS account (multi-account via AssumeRole) | 160+ across 39 sections |
...
- **160+ security checks** across 39 audit sections
...
- **180 unit tests** -- full test suite with mock boto3, no AWS credentials needed (incl. internet-exposure and deep-plane false-positive/false-negative catalogs)
...
```bash
# Run full audit (all 39 sections, 160+ checks)
...
usage: aws_live_scanner.py [-h] [--region REGION] [--json FILE] [--html FILE]
                            ...
                            [--sections {IAM,S3,VPC,LOGGING,KMS,EC2,ECR,BACKUP,
                                         ...
                                         APIGATEWAYV2,IAMPRIVESC,EXPOSURE,VULN,THREAT,DATA}]
...
### Security Checks Coverage (160+ checks across 39 sections)
...
├── aws_live_scanner.py      # Live Audit Scanner v2.4.0 (39 sections, graph, exposure, deep-plane)
