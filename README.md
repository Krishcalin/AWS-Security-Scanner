...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/checks-517%20severity--mapped-red?style=flat-square" alt="517 severity-mapped checks"/>
...
- [Live Audit Scanner (`aws_live_scanner.py`)](#live-audit-scanner-aws_live_scannerpy)
  ...
  - [Security Checks Coverage (517 severity-mapped checks across 95 sections)](#security-checks-coverage-517-severity-mapped-checks-across-95-sections)
...
|---------|------|------|-------|--------|
| **OverWatch** (Live CNAPP) | `aws_live_scanner.py` | Live AWS API audit + security graph + attack-path CNAPP | Running AWS account (multi-account via AssumeRole) | 517 severity-mapped across 95 sections |
...
- **517 severity-mapped checks** across 95 audit sections (all 517 actionable, each with a detailed remediation write-up)
...
```bash
# Run full audit (all 95 sections, 517 severity-mapped checks)
...
### Security Checks Coverage (517 severity-mapped checks across 95 sections)
