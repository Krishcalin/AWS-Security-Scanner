...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/checks-535%20severity--mapped-red?style=flat-square" alt="535 severity-mapped checks"/>
...
- [Live Audit Scanner (`aws_live_scanner.py`)](#live-audit-scanner-aws_live_scannerpy)
  ...
  - [Security Checks Coverage (535 severity-mapped checks across 97 sections)](#security-checks-coverage-535-severity-mapped-checks-across-97-sections)
...
|---------|------|------|-------|--------|
| **OverWatch** (Live CNAPP) | `aws_live_scanner.py` | Live AWS API audit + security graph + attack-path CNAPP | Running AWS account (multi-account via AssumeRole) | 535 severity-mapped across 97 sections |
...
- **535 severity-mapped checks** across 97 audit sections (all 535 actionable, each with a detailed remediation write-up)
...
```bash
# Run full audit (all 97 sections, 535 severity-mapped checks)
...
### Security Checks Coverage (535 severity-mapped checks across 97 sections)
