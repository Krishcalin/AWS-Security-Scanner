...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/checks-532%20severity--mapped-red?style=flat-square" alt="532 severity-mapped checks"/>
...
- [Live Audit Scanner (`aws_live_scanner.py`)](#live-audit-scanner-aws_live_scannerpy)
  ...
  - [Security Checks Coverage (532 severity-mapped checks across 97 sections)](#security-checks-coverage-532-severity-mapped-checks-across-97-sections)
...
|---------|------|------|-------|--------|
| **OverWatch** (Live CNAPP) | `aws_live_scanner.py` | Live AWS API audit + security graph + attack-path CNAPP | Running AWS account (multi-account via AssumeRole) | 532 severity-mapped across 97 sections |
...
- **532 severity-mapped checks** across 97 audit sections (all 532 actionable, each with a detailed remediation write-up)
...
```bash
# Run full audit (all 97 sections, 532 severity-mapped checks)
...
### Security Checks Coverage (532 severity-mapped checks across 97 sections)
