...
FLOORS = {
    ...
    "test_cnapp_scheduling.py": 32,
    "test_cnapp_service.py": 11,
    "test_cnapp_validate.py": 12,
    "test_cnapp_worker.py": 9,
    "test_cnapp_worker_wiring.py": 19,
    ...
    "test_console_output_is_reachable.py": 10,
    "test_controls.py": 15,
    "test_copilot.py": 18,
    ...
    "test_data_paths.py": 4,
    "test_db_engine_routing.py": 43,
    ...
    "test_export_detail_wiring.py": 12,
    "test_exposure.py": 56,
    "test_extsvc.py": 51,
    ...
    "test_marketplace_metering.py": 14,
    "test_mcp.py": 34,
    ...
    "test_nhi.py": 41,
    "test_nhi_wiring.py": 20,
    "test_nitro.py": 23,
    "test_nitro_wiring.py": 16,
    "test_offline_gate.py": 31,
    "test_ownership.py": 27,
    ...
    "test_qr.py": 9,
    "test_rbac_roles.py": 26,
    "test_read_failure_is_not_a_finding.py": 29,
    ...
    "test_remediation_cli_verbs.py": 10,
    ...
    "test_scorecards_api.py": 13,
    "test_sdk_pin.py": 7,
    "test_secrets.py": 9,
    "test_secrets_collector.py": 7,
    "test_section_reachability.py": 12,
    ...
    "test_unproven_checks_tranche5.py": 42,
    "test_unproven_checks_tranche6.py": 25,
    "test_unproven_checks_tranche7.py": 11,
    "test_unproven_checks_tranche8.py": 85,
    "test_unreached_modules.py": 7,
    "test_unused.py": 21,
